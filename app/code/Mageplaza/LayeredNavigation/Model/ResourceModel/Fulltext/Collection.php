...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    /** @var bool If this variable is True, the search result will not separate item by page */
    protected $_getAllData = false;
    ...
    public function __construct(
        ...
        \Magento\Framework\DB\Adapter\AdapterInterface|null $connection = null,
        $searchRequestName = 'catalog_view_container',
        ProductLimitationFactory|null $productLimitationFactory = null,
        MetadataPool|null $metadataPool = null,
        \Magento\Framework\Api\Search\SearchCriteriaBuilder|null $searchCriteriaBuilder = null,
        \Magento\Framework\Api\FilterBuilder|null $filterBuilder = null,
        SearchCriteriaResolverFactory|null $searchCriteriaResolverFactory = null,
        SearchResultApplierFactory|null $searchResultApplierFactory = null,
        TotalRecordsResolverFactory|null $totalRecordsResolverFactory = null,
        DefaultFilterStrategyApplyCheckerInterface|null $defaultFilterStrategyApplyChecker = null
    ) {
        parent::__construct(
            $entityFactory,
            $logger,
        ...
        $this->searchCriteriaBuilder             = $searchCriteriaBuilder ?: ObjectManager::getInstance()
            ->get(\Mageplaza\LayeredNavigation\Model\Search\SearchCriteriaBuilder::class);
    ...
    /**
     * MP function Clone collection
     *
     * @param bool $isReturn
     *
     * @return $this|Collection
     */
    public function getCollectionClone($isReturn = true)
    {
    ...
    /**
     * MP function remove attribute from collection to count product in option attribute
     *
     * @param $attributeCode
     *
     * @return Collection
    ...
    /**
     * MP function Add multi-filter categories
     *
     * @param $categories
     *
     * @return $this
    ...
    /**
     * MP function reset category filter
     *
     * @param $categoryIds
     *
     * @return $this
    ...
    /**
     * MP function set category filter
     *
     * @param $categoryIds
     *
     * @return Collection
    ...
    /**
     * MP function reset category ids
     *
    ...
    /**
     * MP function Reset Total records
     *
     * @return $this
     */
    ...
    public function addFieldToFilter($field, $condition = null)
    {
        ...
        } elseif (!is_array($condition) || !in_array(key($condition), ['from', 'to'], true)) {
            $this->filterBuilder->setField($field);
    ...
    /**
     * Function to change the _getAllData variable
     *
     * @param $isGetAll
     *
     * @return $this
     */
    public function setGetAllData($isGetAll)
    {
        $this->_getAllData = $isGetAll;
    ...
    {
        $size        = $this->_getAllData ? 1000 : $this->getPageSize();
        $currentPage = $this->_getAllData ? 1 : (int) $this->_curPage;
